...
class OceanoeCEL(Scene):
    """
    v2.1.3 - Igual que v2.1.2 pero SIN FONDO al final

    Copia de v2.1.2 con fade out del fondo después de generar el halo.
    Solo queda visible: masa + halo de eCEL organizado.
    """
