...
class LeSageComparacion(Scene):
    """
    LeSage v1.2.0 - Mapa de calor atmosférico

    Paleta térmica NASA/AIRS:
    FRÍO: Púrpura → Azul → Cyan → Amarillo → Naranja → Rojo :CALIENTE

    - Inicio: planeta frío (púrpura/azul)
    - Lluvia empuja colores hacia el rojo
    - Final: esfera roja líquida como un sol
    """
    ...
    def construct(self):
        ...
        # Paleta FRÍA inicial (púrpura/azul)
        COLOR_FRIO = PURPLE_E
    ...
    def calentamiento_con_contador(self, duracion=25, centro=ORIGIN, label=None, barra_fondo=None):
        ...
        # Paleta térmica NASA/AIRS (frío → caliente)
        # Púrpura → Azul → Cyan → Amarillo → Naranja → Rojo
        colores_planeta = [PURPLE_E, BLUE, BLUE_A, YELLOW, ORANGE, RED]
...
# Para renderizar:
# manim -pqh LeSage-v1.2.0.py LeSageComparacion
